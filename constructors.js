...
mango.changeEmail('valera@mail.com')

const apple = new User({ email: 'apple@mail.com', password: 2222222 });
...
// User.prototype.logInfo = function (mail ,password) {
//   console.log('Почта: ', this.email = mail);
//   console.log('Пароль: ', this.password = password);
// };

// mango.logInfo('vlad@gmail.com', 1123456)
// console.log(mango)